...
int jeu_ordinateur(JOUEUR_TRIOMINOS ordi, EMPLACEMENT **tabEmplacement)
{
  ...
  else
  {
    ...
    if (taille_coups > 0)
    {
      ...
      tabEmplacement[coup_joue.indice_ligne][coup_joue.indice_colonne].trio = trio_joue;
      // FIXME: :tabEmplacement[coup_joue.indice_ligne][coup_joue.indice_colonne].pointe =
