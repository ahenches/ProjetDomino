...
int joueur_qui_commence(NB_JOUEURS nb_joueurs,JOUEUR_TRIOMINOS *joueurs, PIOCHE_TRIOMINOS pioche_initiale);
void distribution(NB_JOUEURS nb_joueurs, JOUEUR_TRIOMINOS *joueurs,PIOCHE_TRIOMINOS *pioche_initiale);
BOOL test_fin(NB_JOUEURS nb_joueurs, JOUEUR_TRIOMINOS *joueurs,PIOCHE_TRIOMINOS pioche, EMPLACEMENT **tabEmplacement);

BOOL pioche(MAIN_J_TRIOMINOS *main, PIOCHE_TRIOMINOS *pioche);
BOOL est_plateau_vide(EMPLACEMENT **tabEmplacement);
int trouve_coups_legaux(JOUEUR_TRIOMINOS j, EMPLACEMENT **tabEmplacement,COUP *coups_legaux[N_COUPS_MAXIMAL]);
